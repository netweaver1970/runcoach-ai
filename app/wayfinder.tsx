...
const makeStyles = (c: Palette) => StyleSheet.create({
  ...
  clearX: { fontSize: 14, fontWeight: '700', color: c.accent },
  ...
  chipT: { fontSize: 15, fontWeight: '600', color: c.textSub },
  chipTOn: { color: '#fff' },
  ...
  zoomTsm: { fontSize: 13, fontWeight: '800', color: '#222' },
  ...
  followT: { color: '#fff', fontSize: 13, fontWeight: '700' },
  ...
  fullT: { fontSize: 15, fontWeight: '800', color: '#222' },
