...
const makeStyles = (c: Palette) => StyleSheet.create({
  ...
  chevron:  { color: c.textFaint, fontSize: 16, fontWeight: '700', width: 14, textAlign: 'center' },
  ...
  cbBox:    { width: 20, height: 20, borderRadius: 5, borderWidth: 1.5, borderColor: c.textFaint, color: c.onAccent, textAlign: 'center', fontSize: 16, fontWeight: '800', overflow: 'hidden', lineHeight: 18 },
