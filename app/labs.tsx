...
const makeStyles = (c: Palette) => StyleSheet.create({
  ...
  importTxt:{ color: c.text, fontSize: 15, fontWeight: '700' },
  ...
  pillOff:  { opacity: 0.5 },
  pillTxt:  { color: c.text, fontSize: 17, fontWeight: '700' },
  ...
  cbBox:    { width: 22, height: 22, borderRadius: 6, borderWidth: 1.5, borderColor: c.textFaint, color: c.onAccent, textAlign: 'center', fontSize: 16, fontWeight: '800', overflow: 'hidden', lineHeight: 19 },
