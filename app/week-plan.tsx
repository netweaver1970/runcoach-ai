...
const makeStyles = (c: Palette) => StyleSheet.create({
  ...
  periodLine:{ fontSize: 14, fontWeight: '800', color: c.accent, marginTop: -4, marginBottom: 10 },
  ...
  raceTitle: { fontSize: 15, fontWeight: '800', color: c.text, marginBottom: 3 },
  ...
  travelBtnText: { color: c.accent, fontWeight: '700', fontSize: 15 },
